...
class RepositoryTests: XCTestCase {
    ...
    func testLocalRepositoryReturnHouseByNameWithTypeSafe() {
        let lannisterHouse = Repository.local.house(named: .stark)
        
        XCTAssertEqual(lannisterHouse?.name, "Lannister")
    }
